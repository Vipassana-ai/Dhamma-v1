...
"MSWin32-x86-multi-thread-64int-10.0.18363.720" or
	die "Errno architecture (MSWin32-x86-multi-thread-64int-10.0.18363.720) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEADDRINUSE WSAEPROTOTYPE WSAEOPNOTSUPP WSAENETRESET WSAEISCONN
	WSAEMFILE WSAEPROTONOSUPPORT WSAEREMOTE WSAEHOSTDOWN WSAECONNRESET
	WSAENETUNREACH WSAEINVALIDPROCTABLE WSAEREFUSED WSAENOTCONN
	WSAECONNABORTED WSAENOBUFS WSAEBADF WSAETIMEDOUT WSAEALREADY
	WSAEDESTADDRREQ WSAEMSGSIZE WSAESTALE WSAEWOULDBLOCK WSAESHUTDOWN
	WSAENOTSOCK WSAEINPROGRESS WSAEACCES WSAEHOSTUNREACH WSAETOOMANYREFS
	WSAESOCKTNOSUPPORT WSAEINVAL WSAENETDOWN WSAECANCELLED WSAEUSERS
	WSAEINTR WSAENOMORE WSAENOPROTOOPT WSAEDQUOT WSAELOOP WSAENAMETOOLONG
	WSAEFAULT WSAEPROCLIM WSAEAFNOSUPPORT WSAEPFNOSUPPORT
	WSAEPROVIDERFAILEDINIT WSAENOTEMPTY WSAEADDRNOTAVAIL WSAEDISCON
	WSAEINVALIDPROVIDER WSAECONNREFUSED
    )],
);
